...
require_relative '../../app/helpers/api/v1/marsrovers_helper'

class MarsroversHelperTest < ActiveSupport::TestCase

  planet = Planet.new(5, 5)

  test "input has correct number of lines" do
    input_commands = "5 5\n1 2 N\nMM"
    assert_equal true, Api::V1::MarsroversHelper.validate_input_data_lines(input_commands)
  end

  test "input has incorrect number of lines" do
    input_commands = "5 5\n1 2 N"
    assert_equal false, Api::V1::MarsroversHelper.validate_input_data_lines(input_commands)
  end

  test "rover commands are correct" do
    input_commands = "LRM"
    assert_equal true, Api::V1::MarsroversHelper.validate_rover_movements(input_commands)
  end

  test "rover input commands black are controlled" do
    input_commands = ""
    assert_equal false, Api::V1::MarsroversHelper.validate_rover_movements(input_commands)
    assert_equal false, Api::V1::MarsroversHelper.validate_rover_movements(nil)
  end
  ...
  test "build planet" do
    input_data = "2 5"
    planet = Api::V1::MarsroversHelper.build_planet(input_data)
  ...
  test "build rover" do
    input_data = "1 2 N"
    rover = Api::V1::MarsroversHelper.build_rover(planet, input_data)
  ...
  test "read commands ok" do
    input_data = "LMRM"
    command_list = Api::V1::MarsroversHelper.build_command_list(input_data)
